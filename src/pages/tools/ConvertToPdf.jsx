...
const ConvertToPdf = () => {
    ...
    const config = TO_PDF_FORMATS[format];
    ...
    return (
        <PdfToolLayout
            ...
            description={t('pdfTools.toPdfPageDescription', { format: config.displayName })}
            ...
            <div className="space-y-6">
                {!job.file ? (
                    <PdfDropzone
                        ...
                        label={t('pdfTools.dropzoneLabelFormat', { format: config.displayName })}
                    ...
                    <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4">
                        <div className="flex items-center gap-3">
                            <config.icon className="text-blue-600" size={22} />
                            <div>
